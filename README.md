...
一款面向 macOS、截图内容在本机处理的截图工具：完成区域、窗口、全屏和区域长截图，并在本机进行标注、OCR、原位置翻译、置顶、美化和历史搜索。

LocalShot 不包含视频录制、账号、云同步、广告或在线存储。截图和识别内容不会上传；直接分发版只会访问公开 GitHub Release 检查和下载软件更新。

## 下载

当前公开测试版：**0.1.3（Build 6）**

[前往 GitHub Releases 下载 LocalShot](https://github.com/tpxcer/LocalShot-Downloads/releases/tag/v0.1.3-build6)

下载文件：`LocalShot-0.1.3-build6-offline-license-arm64.dmg`

> 当前版本仅支持 Apple 芯片 Mac，最低需要 macOS 13。安装包尚未经过 Apple 公证，首次打开时需要按照[安装说明](INSTALL.md)完成系统确认。

> Build 4 及更早版本没有更新检查功能，需要手动安装 Build 6；Build 5 用户可直接在软件内收到 Build 6 更新提示。

## 软件截图

### 快捷截图与即时标注

进入区域截图时使用清晰的彩虹箭头光标。拖选区域后，可直接添加粗箭身实心箭头、步骤、文字、矩形、马赛克或模糊；完成后可复制、另存、OCR、翻译或置顶。
...
- 粗箭身、大实心三角头箭头，以及画笔、文字、步骤编号、椭圆和直角矩形。
...
1. 从 [Build 6 Release](https://github.com/tpxcer/LocalShot-Downloads/releases/tag/v0.1.3-build6) 下载 DMG。
...
```bash
shasum -a 256 -c SHA256SUMS-v0.1.3-build6-public.txt
```
...
- 自动更新检查只查询公开 GitHub Release，不发送截图、OCR、机器码、授权码、历史或文件路径；可在设置中关闭。
