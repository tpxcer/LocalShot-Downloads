...
当前公开测试版：**0.2.0（Build 12）**

[前往 GitHub Releases 下载 LocalShot](https://github.com/tpxcer/LocalShot-Downloads/releases/tag/v0.2.0-build12)

下载文件：`LocalShot-0.2.0-build12-offline-license-arm64.dmg`

> 当前版本仅支持 Apple 芯片 Mac，最低需要 macOS 13。安装包尚未经过 Apple 公证，首次打开时需要按照[安装说明](INSTALL.md)完成系统确认。

> Build 4 及更早版本没有更新检查功能，需要手动安装 Build 12；Build 5–11 用户可直接在软件内收到 Build 12 更新提示。
...
在 macOS 15 或更高版本中框选需要录制的屏幕区域，红色细边框会持续显示。悬浮控制条提供录制计时、系统声音、麦克风、取消和开始/停止按钮；系统声音默认开启，麦克风默认关闭。完成后视频以 H.264 MP4 保存在本机独立录制目录。
...
- 区域录屏：自由框选录制范围，持续显示红框和计时，可选择系统声音与麦克风。
...
1. 从 [Build 12 Release](https://github.com/tpxcer/LocalShot-Downloads/releases/tag/v0.2.0-build12) 下载 DMG。
...
```bash
shasum -a 256 -c SHA256SUMS-v0.2.0-build12-public.txt
```
