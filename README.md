...
当前公开测试版：**0.1.5（Build 8）**

[前往 GitHub Releases 下载 LocalShot](https://github.com/tpxcer/LocalShot-Downloads/releases/tag/v0.1.5-build8)

下载文件：`LocalShot-0.1.5-build8-offline-license-arm64.dmg`

> 当前版本仅支持 Apple 芯片 Mac，最低需要 macOS 13。安装包尚未经过 Apple 公证，首次打开时需要按照[安装说明](INSTALL.md)完成系统确认。

> Build 4 及更早版本没有更新检查功能，需要手动安装 Build 8；Build 5/6/7 用户可直接在软件内收到 Build 8 更新提示。
...
1. 从 [Build 8 Release](https://github.com/tpxcer/LocalShot-Downloads/releases/tag/v0.1.5-build8) 下载 DMG。
...
```bash
shasum -a 256 -c SHA256SUMS-v0.1.5-build8-public.txt
```
