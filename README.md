...
当前公开测试版：**0.3.2（Build 16）**

[前往 GitHub Releases 下载 LocalShot](https://github.com/tpxcer/LocalShot-Downloads/releases/tag/v0.3.2-build16)

下载文件：`LocalShot-0.3.2-build16-offline-license-universal2-arm64-x86_64.dmg`

> 当前版本同时支持 Apple 芯片和 Intel Mac，最低需要 macOS 13。安装包尚未经过 Apple 公证，首次打开时需要按照[安装说明](INSTALL.md)完成系统确认。

> Build 4 及更早版本没有更新检查功能，需要手动安装 Build 16；Build 5–15 用户可直接在软件内收到 Build 16 更新提示。
...
Build 16 使用同一个 Universal 2 安装包覆盖两种处理器架构，不需要区分下载版本。

## 安装与首次使用

1. 从 [Build 16 Release](https://github.com/tpxcer/LocalShot-Downloads/releases/tag/v0.3.2-build16) 下载 DMG。
...
```bash
shasum -a 256 -c SHA256SUMS-v0.3.2-build16-public.txt
```
