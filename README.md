...
当前公开测试版：**0.1.4（Build 7）**

[前往 GitHub Releases 下载 LocalShot](https://github.com/tpxcer/LocalShot-Downloads/releases/tag/v0.1.4-build7)

下载文件：`LocalShot-0.1.4-build7-offline-license-arm64.dmg`

> 当前版本仅支持 Apple 芯片 Mac，最低需要 macOS 13。安装包尚未经过 Apple 公证，首次打开时需要按照[安装说明](INSTALL.md)完成系统确认。

> Build 4 及更早版本没有更新检查功能，需要手动安装 Build 7；Build 5/6 用户可直接在软件内收到 Build 7 更新提示。

## 软件截图

### 快捷截图与即时标注

进入区域截图时使用与系统默认指针同尺寸的彩虹箭头光标，并提供扩大后的方形像素放大镜。拖选区域后，可直接添加粗箭身实心箭头、步骤、文字、矩形、马赛克或模糊；完成后可复制、另存、OCR、翻译或置顶。
...
1. 从 [Build 7 Release](https://github.com/tpxcer/LocalShot-Downloads/releases/tag/v0.1.4-build7) 下载 DMG。
...
```bash
shasum -a 256 -c SHA256SUMS-v0.1.4-build7-public.txt
```
